...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    } else if ([@"scanAlbum" isEqualToString:call.method]) {
        [_scanner scanAlbum:call result:result];
    ...
    } else if ([@"getAllLivePhoto" isEqualToString:call.method]) {
        [_scanner getAllLivePhoto:call result:result];
    } else if ([@"getAllGif" isEqualToString:call.method]) {
        [_scanner getAllGif:call result:result];
